  ...
  return (ready ? (
    <Container className="py-3">
      <Row className="justify-content-center py-3">
        <Col>
          <Col className="text-center">
            <h2 className="fw-bold">Edit Hemenway Hall Vendors</h2>
          </Col>
        </Col>
      </Row>
      ...
      <Row xs={1} md={2} lg={3} className="g-4 py-4">
        {vendor.filter(place => place.location === 'Hemenway Hall').map((place) => (<Col key={place._id}><PlaceToEatEdit place={place} /></Col>))}
      </Row>
    </Container>
  ) : <LoadingSpinner />);
};

export default EditHemenwayHall;
